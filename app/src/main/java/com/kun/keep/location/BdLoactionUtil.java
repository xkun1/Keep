...
public class BdLoactionUtil {
    ...
    public static BdLoactionUtil getInstance() {
        return LocationHolder.INSTANCE;
    }

    private static class LocationHolder {
        private static final BdLoactionUtil INSTANCE = new BdLoactionUtil();
    }

    private BdLoactionUtil() {
    }
    ...
    public void requestLocation(final MyLocationListener listener) {
        //声明LocationClient类
        locationClient = new LocationClient(KeepApplicon.getInstances());
        // 设置定位条件
