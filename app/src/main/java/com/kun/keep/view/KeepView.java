...
/**
 * user:kun
 * Date:2018/4/23 or 1:22 PM
 * email:hekun@gamil.com
 * Desc:画圆弧的view
 */
public class KeepView extends View {
    ...
    public KeepView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public KeepView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色，黄色 */
        paint.setColor(Color.parseColor(Constant.COLOR_ARC_WIDE));
        /** 结合处为圆弧*/
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(Color.parseColor(Constant.COLOR_ARC));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(Color.parseColor(Constant.COLOR_NUMBER));
